...
This module provides one-to-one relationship field types for handling relationships between models.
It supports:
...
Examples:
    >>> class Profile(Model):
    ...     user = OneToOneField("User", reverse_name="profile")
    ...     bio = StringField()
    ...     avatar = ImageField()
    ...
    >>> class User(Model):
    ...
    ...     # profile field will be added automatically with reverse_name="profile"
"""
...
class OneToOneField(Field[Optional[M]]):
    """Field for one-to-one relationships.
