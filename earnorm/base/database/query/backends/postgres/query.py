...
This module provides PostgreSQL query implementation.
...
class PostgresQuery(Query[Any]):
    """PostgreSQL query implementation.

    This class represents a PostgreSQL query with SQL and parameters.
